...
class AppColor {
  ...
  static const Color secondaryGrayColor = Color(0xff42505C);
  static const Color lightGrayColor = Color(0xff79828B);
  ...
  static const Color secondBlueColor = Color(0xff003E90);
